...
Ans: `Misc.Feature`, `Alley`, `Pool.QC`
...
Ans:21 houses do not have a basement.
...
Ans: With a p-value near 0.000, we reject the null hypothesis of no difference
...
Ans: 'price` cannot take on negative values
