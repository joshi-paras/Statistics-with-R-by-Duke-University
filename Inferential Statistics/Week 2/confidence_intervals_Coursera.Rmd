...
```
Typical size is described as the median area
...
Ans: The sample distribution must be nearly normal
...
Ans: 95% confident that the sample mean is in this interval
